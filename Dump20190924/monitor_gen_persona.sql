...
CREATE TABLE `gen_persona` (
  ...
  PRIMARY KEY (`id`),
  KEY `REL_4000` (`id_compania`),
  CONSTRAINT `REL_4000` FOREIGN KEY (`id_compania`) REFERENCES `gen_compania` (`id`)
...
INSERT INTO `gen_persona` VALUES (1,1,'928820215','orlando.camavilca@gmail.com','orlando','camavilca','chavez'),(2,1,'123456789','diego@gmail.com','diego','rayme','martinez'),(3,1,'92882231','edu.camavilca@gmail.com','edu','chavez','camavilca ');
